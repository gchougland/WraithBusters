...
public final class ActionWraithBustersCheeseChaseMouse extends ActionBase {
    public ActionWraithBustersCheeseChaseMouse(
        @Nonnull BuilderActionWraithBustersCheeseChaseMouse builder,
    ...
    public boolean execute(
        ...
        return CheeseChaseService.tryCatchMouse(session, world, playerRef, store, ref);
    }
}
